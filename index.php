...
<body>
    <div class="arin-container">
                        ...
                        <li>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    <a href="studentlogin.php">Student<br> Login</a>
                                    <a href="adminLogin.php">Admin<br> Login</a>
        ...
        <div class="w3-content w3-display-container ">
            <img class="mySlides" src="css/img/img_snowtops.jpg" style="width:1400px;  height:500px;">
            <img class="mySlides" src="css/img/img_lights.jpg" style="width:1400px;  height:500px;">
            <img class="mySlides" src="css/img/img_mountains.jpg" style="width:1400px; height:500px;">
            <img class="mySlides" src="css/img/img_forest.jpg" style="width:1400px;  height:500px;">
        ...
        <div class="#">
            <div class="sum-tog">
                <div class="sum-item">
                    ...
                    <p>To develop the civil and military <br>human capital through advanced education<br> and research
                        to respond to the knowledge-based <br>society of the contemporary world.</p>
